...
from ..tools.fields import (identifier_field, ultimate_strength_field,
                            stress_field)
...
if __name__ == '__main__':
  ...
  parser = argparse.ArgumentParser(
    description="For each source file determines the ultimate strength, and "
                "then saves it in the destination file.")
